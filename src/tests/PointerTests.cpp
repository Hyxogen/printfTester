...
BONUS_SINGLE_SPECIFIER_ZERO_FLAG_TEST(pointer, "p", GetTestVector())
...
BONUS_SINGLE_SPECIFIER_STRING_ZERO_FLAG_TEST(pointer, "p", GetTestVector())
...
BONUS_TWO_SPECIFIER_STRING_ZERO_FLAG_TEST(pointer, "p", GetTestVector())
#endif