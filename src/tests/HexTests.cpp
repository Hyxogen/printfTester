...
BONUS_SINGLE_SPECIFIER_BLANK_FLAG_TEST(hex, "x", GetTestVector())
...
BONUS_SINGLE_SPECIFIER_STRING_BLANK_FLAG_TEST(hex, "x", GetTestVector())
...
BONUS_TWO_SPECIFIER_STRING_BLANK_FLAG_TEST(hex, "x", GetTestVector())
...
BONUS_SINGLE_SPECIFIER_BLANK_FLAG_TEST(uhex, "X", GetTestVector())
...
BONUS_SINGLE_SPECIFIER_STRING_BLANK_FLAG_TEST(uhex, "X", GetTestVector())
...
BONUS_TWO_SPECIFIER_STRING_BLANK_FLAG_TEST(uhex, "X", GetTestVector())
